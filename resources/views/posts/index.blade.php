...
@section('title', __('posts.page_title'))
@section('description', __('posts.page_description'))
    ...
    <div class="px-6 mx-auto max-w-7xl lg:px-8">
      ...
      @else
        <div class="text-center">
          ...
          <h3 class="mt-4 text-lg font-medium text-gray-900">{{ __('posts.no_posts_title') }}</h3>
          <p class="mt-2 text-gray-500">{{ __('posts.no_posts_description') }}</p>
        </div>
      @endif
    </div>
  </div>
