      ...
      <div class="hs-accordion-group">
        ...
        <div class="hs-accordion hs-accordion-active:bg-gray-100 p-6"
          ...
          <button
            ...
            Můžete zajistit přepravu pro větší skupiny?
            <svg class="hs-accordion-active:hidden block shrink-0 size-5 text-primary group-hover:text-gray-500 "
              xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="m6 9 6 6 6-6" />
            </svg>
            <svg class="hs-accordion-active:block hidden shrink-0 size-5 text-primary group-hover:text-gray-500 "
              xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="m18 15-6-6-6 6" />
            </svg>
